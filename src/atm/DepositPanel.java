...
public class DepositPanel extends ReUsable_Codes
{
    protected void DepositP()
    {
        jf.setVisible(true);
        jf.setLayout(null);
        jf.setSize(1152,668);
    ...
    jp.repaint();
    ImageIcon dp_icon = new ImageIcon(MyPath+"ATM\\src\\ISVAO\\Dp.png");
    JButton depositb=new JButton(" Deposit",dp_icon);
    depositb.setBounds(580, 370,350,60);
    depositb.setFont(new Font("Arial",Font.BOLD,30));
    depositb.setBorder(BorderFactory.createBevelBorder(0));
    depositb.setForeground(Color.WHITE);
    depositb.setBackground(Color.decode("#4F81BD"));
    depositb.setToolTipText("Deposits Amount In Account");
    depositb.repaint();
    jp.add(depositb);
    button_hover(depositb);
                ...
                if(!(amtb.getText().equals("")))
                {
                    ...
                    confirm.addActionListener(new ActionListener() 
                    {
                        ...
                        public void actionPerformed(ActionEvent actionEvent) 
                        {
                            ...
                            int datTi[]=new int[6];
                            datTi=VM_Date_Time();
                            Insert_In_Transaction_Table(Account_Number,datTi[0],datTi[1],datTi[2], datTi[3], datTi[4], datTi[5], "Vile Parle(East)",57, "Deposition",null, Amt_B_T,Amt_T, Amt_A_T);
                            ...
                            JLabel Trans_t=new JLabel("DEPOSIT",SwingConstants.LEFT);
                            ...
                            JLabel sss=new JLabel("DEPOSIT SUCCESSFUL",SwingConstants.CENTER);
...
//                                            cl.stop();
                    ...
                    ImageIcon dpc_icon = new ImageIcon(MyPath+"ATM\\src\\ISVAO\\Dp.png");
                    JOptionPane.showOptionDialog(null,("<html><h1>You Want to deposit rs."+amtb.getText()+"<br>into your account: "+acc_No_hider(Account_Number)+"</h1></html>").toUpperCase(),("deposit confirmation").toUpperCase(),JOptionPane.YES_NO_OPTION,JOptionPane.PLAIN_MESSAGE, dpc_icon,bs,null);
                    ...
                    else
                    {
                            ...
                            JButton bs[]={kkk};
                            ImageIcon dpc_icon = new ImageIcon(MyPath+"ATM\\src\\ISVAO\\Dp.png");
                            JOptionPane.showOptionDialog(null,("<html><h1>please enter an amount </h1></html>").toUpperCase(),("Empty Field").toUpperCase(),JOptionPane.YES_NO_OPTION,JOptionPane.PLAIN_MESSAGE, dpc_icon,bs,null);
