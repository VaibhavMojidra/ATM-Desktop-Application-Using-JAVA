...
public class CheckBalancePanel extends ReUsable_Codes
{
    protected void CheckBalanceP()
    {
                jf.setVisible(true);
        jf.setLayout(null);
        jf.setSize(1152,668);
        jf.setTitle("STATE BANK -CHECK BALANCE");
        ...
        JPanel r_jp=new JPanel();
                            ...
                            int datTi[]=new int[6];
                            datTi=VM_Date_Time();
                            String Amt=get_custumer_details(6,Account_Number);
                            ...
                            JLabel Trans_t=new JLabel("",SwingConstants.LEFT);
                            ...
                            JLabel amtL=new JLabel("",SwingConstants.RIGHT);
                            ...
                            JLabel ab=new JLabel("AMT. RS."+Amt,SwingConstants.RIGHT);
                            ...
                            JLabel sss=new JLabel("<html>Available Balance:<br>"+Amt+"<html>",SwingConstants.CENTER);
                            sss.setFont(new Font("Arial Unicode MS",Font.BOLD,40));
                            sss.setForeground(Color.BLACK);
                            sss.setOpaque(true);
                            sss.setBounds(450,50,600,100);
                            jp.add(sss);
                            jp.repaint();
